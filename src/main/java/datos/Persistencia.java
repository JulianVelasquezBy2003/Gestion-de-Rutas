...
/* 
lee y escribe la informacion del sistema en los archivos XML de src/main/resources/xml 
(persistencia de datos), y de reconstruir los arreglos en memoria (Usuario[], Ruta[], Viaje[][]) 
    ...
    public Viaje[] buscarViajesPorDestino(String destino) {
        ...
        for (int fila = 0; fila < MAX_DESTINOS; fila++) {
            ...
            if (destinoDeLaFila != null && destinoDeLaFila.equalsIgnoreCase(destino)) {
                ...
                break; // Al encontrar la fila del destino sale
            }
        }
